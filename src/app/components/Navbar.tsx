...
const Navbar = () => {
  return (
    //header
    <header className='max-w-[1920px] h-[220px] bg-slate-200 flex flex-col mx-auto'>
      {/*  title  */}
      <div className=' flex justify-center'>
        <h1 className='sm:text-7xl text-2xl font-extrabold text-primary'>
          The Dream
          <span className='sm:text-7xl  text-2xl text-gray-400'>  Destinations</span>
        </h1>
      </div>

      {/* Links and Search section */}
      <div className='max-w-[1920px] h-[57px] bg-slate-200 flex flex-row justify-between
